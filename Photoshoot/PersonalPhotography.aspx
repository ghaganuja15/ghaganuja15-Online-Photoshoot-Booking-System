<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PersonalPhotography.aspx.cs" Inherits="PersonalPhotography" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
        <link rel="stylesheet" type="text/css" href="PersonalPhotography.css" />
    <h2 class="auto-style2" style="margin-left: 600px">Personal Photography</h2>
     <img src="images/wedding3.jpg" alt="Banner Image" style="height: 572px; width: 1430px; margin-top: 5px;">
