...
public partial class AdminPersonalPhotography : System.Web.UI.Page
{
    ...
    private void BindGrid()
    {
        ...
        {
            string query = "SELECT * FROM PersonalPhotographyServices";  // Query to fetch all photography services
    ...
    protected void btnAddService_Click(object sender, EventArgs e)
    {
        using (SqlConnection con = new SqlConnection(connectionString))
        {
            string query = "INSERT INTO PersonalPhotographyServices (ServiceName, Description, ImageURL, Price) VALUES (@ServiceName, @Description, @ImageURL, @Price)";
    ...
    protected void GridViewServices_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        using (SqlConnection con = new SqlConnection(connectionString))
        {
            string query = "DELETE FROM PersonalPhotographyServices WHERE ServiceID = @ServiceID";
