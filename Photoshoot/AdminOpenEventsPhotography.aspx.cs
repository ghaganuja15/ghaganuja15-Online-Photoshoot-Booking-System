...
public partial class AdminOpenEventsPhotography : System.Web.UI.Page
{
    ...
    private void BindGrid()
    {
        ...
        {
            string query = "SELECT * FROM EventPhotographyServices";  // Query to fetch all photography services
    ...
    protected void btnAddService_Click(object sender, EventArgs e)
    {
        using (SqlConnection con = new SqlConnection(connectionString))
        {
            string query = "INSERT INTO EventPhotographyServices (ServiceName, Description, ImageURL, Price) VALUES (@ServiceName, @Description, @ImageURL, @Price)";
    ...
    protected void GridViewServices_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        using (SqlConnection con = new SqlConnection(connectionString))
        {
            string query = "DELETE FROM EventPhotographyServices WHERE ServiceID = @ServiceID";
